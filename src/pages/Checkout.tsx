    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Results Section - Moved from top */}
          <div className="bg-gradient-to-r from-primary/10 to-accent/10 py-12 mt-16 rounded-lg">
            <div className="max-w-4xl mx-auto">
          ...
          {/* Problem Solution Section - Moved from top */}
          <div className="bg-gradient-to-r from-destructive/5 to-warning/5 py-12 mt-8 rounded-lg">
            <div className="max-w-4xl mx-auto">
